    ...
    public partial class SchoolContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Class>(entity =>
            {
                ...
                entity.HasIndex(e => e.CourseId, "UQ__Class__8F1EF7AFAD71BDB5")
                    .IsUnique();

                entity.HasIndex(e => e.InstructorId, "UQ__Class__A1EF56E99725104A")
                    .IsUnique();

                entity.HasIndex(e => e.ClassId, "UQ__Class__FDF479873FD503B3")
                    .IsUnique();
            ...
            modelBuilder.Entity<Course>(entity =>
            {
                ...
                entity.HasIndex(e => e.StudentId, "UQ__Course__2A33069B96431076")
                    .IsUnique();

                entity.HasIndex(e => e.CourseId, "UQ__Course__8F1EF7AFAD237141")
                    .IsUnique();
            ...
            modelBuilder.Entity<Instructor>(entity =>
            {
                ...
                entity.HasIndex(e => e.InstructorId, "UQ__Instruct__A1EF56E9AFA557B6")
                    .IsUnique();
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.HasIndex(e => e.StudentId, "UQ__Student__2A33069BD550256C")
                    .IsUnique();
